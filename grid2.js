...
const disble = () => {
    ...
    rateFixV == 0 ? able(true, true, false, "BlanchedAlmond", "white", "white"):parseInt(rateFixV) == 1 ? able(false, false, true, "white", "BlanchedAlmond", "BlanchedAlmond") : rateFixV == 2 ? able(false, false, false, "white", "white", "white")
